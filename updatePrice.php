...
<body class="nav-fixed">
  <div class="d-flex justify-content-center">
    <div class="container px-4">
      ...
      <form id="myform" action="updatePrice.php?id=<?php echo $rowId?>&userId=<?php echo $userId?>" method="post"
        ...
        <section class="col-xl-5">
          ...
          <div class="card-footer border-top-0">
            <div class="d-flex">
              ...
              <a class="btn btn-primary" <?php echo 'href="Product_price.php?userId='.$userId.'' ?>
                type="button">Back</a>
            </div>
          </div>
        </section>
